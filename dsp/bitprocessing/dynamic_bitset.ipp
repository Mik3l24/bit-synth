...
template< typename Block, typename AllocatorOrContainer >
BOOST_DYNAMIC_BITSET_CONSTEXPR20 void
dynamic_bitset< Block, AllocatorOrContainer >::replace_with_and_of( const dynamic_bitset & a, const dynamic_bitset & b )
{
    BOOST_ASSERT( size() == a.size() && size() == b.size() );
    for ( size_type i = 0; i < num_blocks(); ++i ) {
...
template< typename Block, typename AllocatorOrContainer >
BOOST_DYNAMIC_BITSET_CONSTEXPR20 void
dynamic_bitset< Block, AllocatorOrContainer >::replace_with_or_of(  const dynamic_bitset & a, const dynamic_bitset & b )
{
    BOOST_ASSERT( size() == a.size() && size() == b.size() );
    for ( size_type i = 0; i < num_blocks(); ++i ) {
        m_bits[ i ] = a.m_bits[ i ] | b.m_bits[ i ];
...
template< typename Block, typename AllocatorOrContainer >
BOOST_DYNAMIC_BITSET_CONSTEXPR20 void
dynamic_bitset< Block, AllocatorOrContainer >::replace_with_xor_of( const dynamic_bitset & a, const dynamic_bitset & b )
{
    BOOST_ASSERT( size() == a.size() && size() == b.size() );
    for ( size_type i = 0; i < num_blocks(); ++i ) {
        m_bits[ i ] = a.m_bits[ i ] ^ b.m_bits[ i ];
...
template< typename Block, typename AllocatorOrContainer >
BOOST_DYNAMIC_BITSET_CONSTEXPR20 void
dynamic_bitset< Block, AllocatorOrContainer >::replace_with_not_of( const dynamic_bitset & b )
{
    BOOST_ASSERT( size() == b.size() );
    for ( size_type i = 0; i < num_blocks(); ++i ) {
        m_bits[ i ] = ~b.m_bits[ i ];
    }
}
