...
public:
    ...
    //!    Allows to perform `c = a & b;` but in-place, using the existing
    //!    memory in `c`.
    // -----------------------------------------------------------------------
    BOOST_DYNAMIC_BITSET_CONSTEXPR20 void             replace_with_and_of( const dynamic_bitset & a, const dynamic_bitset & b );
    BOOST_DYNAMIC_BITSET_CONSTEXPR20 void             replace_with_or_of(  const dynamic_bitset & a, const dynamic_bitset & b );
    BOOST_DYNAMIC_BITSET_CONSTEXPR20 void             replace_with_xor_of( const dynamic_bitset & a, const dynamic_bitset & b );
    BOOST_DYNAMIC_BITSET_CONSTEXPR20 void             replace_with_not_of( const dynamic_bitset & b );
